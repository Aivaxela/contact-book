...
public class ContactFrame extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Lab10 by Marcum"));
                ...
                try {
                        switch (cbxContactType.getSelectedIndex()) {
                                case 0:
                                        ...
                                        contactArray[index] = new ContactBusiness(name, email, phone, street, city,
                                                        state, zip,
                                                        type,
                                                        dependentInfo);
                                ...
                                case 1:
                                        ...
                                        contactArray[index] = new ContactFamily(name, email, phone, street, city, state,
                                                        zip,
                                                        type,
                                                        dependentInfo);
                                        model.addElement(contactArray[index].toString());
                                ...
                                case 2:
                                        ...
                                        contactArray[index] = new ContactFriend(name, email, phone, street, city, state,
                                                        zip,
                                                        type,
